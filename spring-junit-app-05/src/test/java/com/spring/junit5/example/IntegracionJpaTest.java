...
public class IntegracionJpaTest {
    ...
    void testFindById() {
        ...
        assertEquals("Sam", cuenta.orElse(null).getPersona());
    }

    @Test
    void testFindByPersona() {
        Optional<Cuenta> cuenta = cuentaRepository.findByPersona("Sam");
        assertTrue(cuenta.isPresent());
        assertEquals("Sam", cuenta.orElse(null).getPersona());
    ...
    void testFindByPersonaThrowException() {
        ...
        assertThrows(NoSuchElementException.class,() -> {
           cuenta.orElseThrow( () -> new NoSuchElementException());
        });
...
//        assertEquals(3, cuenta.getId());
    ...
    @Test
    void testDelete() {
        Cuenta cuenta = cuentaRepository.findById(2L).orElseThrow(() -> new NoSuchElementException());
        assertEquals("John", cuenta.getPersona());
        cuentaRepository.delete(cuenta);
        Optional<Cuenta> cuenta1 = cuentaRepository.findById(2L);
        assertThrows(NoSuchElementException.class,() -> {
            cuenta1.orElseThrow( () -> new NoSuchElementException());
        });

        //Cuenta cuenta1 = cuentaRepository.findById(2L).orElseThrow(() -> new NoSuchElementException());
